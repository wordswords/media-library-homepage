...
flaccount=$(find /mnt2/music -type f -iname '*.flac' | wc -l)
mp3count=$(find /mnt2/music -type f -iname '*.mp3' | wc -l)
wavcount=$(find /mnt2/music -type f -iname '*.wav' | wc -l)
oggcount=$(find /mnt2/music -type f -iname '*.ogg' | wc -l)
m4acount=$(find /mnt2/music -type f -iname '*.m4a' | wc -l)
filecount=$(find /mnt2/music -type f | wc -l)
