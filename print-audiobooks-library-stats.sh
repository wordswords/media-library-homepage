...
flaccount=$(find /mnt3/audiobooks -type f -iname '*.flac' | wc -l)
mp3count=$(find /mnt3/audiobooks -type f -iname '*.mp3' | wc -l)
wavcount=$(find /mnt3/audiobooks -type f -iname '*.wav' | wc -l)
oggcount=$(find /mnt3/audiobooks -type f -iname '*.ogg' | wc -l)
m4acount=$(find /mnt3/audiobooks -type f -iname '*.m4a' | wc -l)
filecount=$(find /mnt3/audiobooks -type f | wc -l)
